...
public class PrescribedExam {
    ...
    /**
     * Service médical correspondant à l'examen (optionnel - legacy)
     */
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    // ✅ Devise de l'examen (CDF ou USD) - copiée depuis MedicalService
    ...
    // ═══════════════════════════════════════════════════════════════
    // LIEN VERS LE VRAI EXAMEN DE LABORATOIRE (nouveau système)
    // ═══════════════════════════════════════════════════════════════

    /**
     * ★ Lien vers l'examen de labo réel (nouveau catalogue)
     * Optionnel pour compatibilité avec les anciennes données
     */
    ...
    private void normalizeAndCompute() {
        ...
        // ★ Si un vrai examen est lié, utiliser son prix
        if (examen != null && examen.getPrix() != null) {
            this.unitPrice = examen.getPrix();
