...
export const medicationAPI = {
  ...
  getStockMovementsByStatus: async (status) => {
    const response = await axios.get(`/api/pharmacy/stock/movements/status/${status}`);
    return response.data;
  },

  // 🔧 NOUVEAU: Upload d'un fichier justificatif
  uploadJustificatif: async (file, subdirectory = 'justificatifs') => {
