...
public class LivreCaisseExportService {
    ...
    private void createPDFHeader(Document document, HospitalConfig config) throws DocumentException {
        ...
        Paragraph hospitalNamePara = new Paragraph(hospitalName.toUpperCase(), hospitalFont);
        ...
        // Ligne de séparation avec table (plus de contrôle)
    ...
    private HospitalConfig createDefaultConfig() {
        ...
        config.setHospitalName("CLINIQUE CI UCBC");
        config.setHospitalCode("HOSP-001");
