...
import { Settings as SettingsIcon, Bell, Lock, Globe, Database, Save, Loader2 } from 'lucide-react';
...
const Settings = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      // On construit l'objet de données à envoyer (sans appName et logo - réservés)
      const configData = {
        ...
        <TabsContent value="general" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Informations de visibilité</CardDescription>
            </CardHeader>
