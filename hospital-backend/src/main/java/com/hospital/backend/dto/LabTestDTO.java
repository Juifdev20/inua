...
public class LabTestDTO {
    ...
    // Nouveau champ pour indiquer si le test vient de la finance
    @Builder.Default
    private boolean fromFinance = false;
    
    // Prix unitaire du test de laboratoire
    private BigDecimal unitPrice;
    
    // ✅ AJOUT: Devise du test (USD, CDF)
    private String currency;
    
    // Champs pour le docteur destinataire
