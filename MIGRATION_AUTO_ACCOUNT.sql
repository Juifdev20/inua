-- ============================================
-- 🚀 MIGRATION : Automatisation des Comptes Utilisateurs (Inua Afia)
-- Date : 2024
-- ============================================
...
-- Note : Vérifiez d'abord s'il n'y a pas de contrainte d'unicité qui bloque
ALTER TABLE users 
...
-- 2. Si nécessaire, supprimer temporairement l'index d'unicité sur email
