...
public class HospitalConfig {
    ...
    @Builder.Default
    private java.math.BigDecimal fichePrice = new java.math.BigDecimal("3"); // 3 USD par défaut
    ...
    protected void onCreate() {
        if (this.fichePrice == null) {
            this.fichePrice = new java.math.BigDecimal("3"); // 3 USD par défaut
        }
        if (this.fichePriceCurrency == null) {
            this.fichePriceCurrency = Currency.USD;
        }
    }
