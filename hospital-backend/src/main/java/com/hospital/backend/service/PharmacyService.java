...
public interface PharmacyService {
     ...
     * Déclenche le déstockage et met à jour le statut à PAYEE
     * 
     * @param orderId ID de la commande
     * @param cashierId ID du caissier qui confirme
     * @param amountPaid Montant payé
     * @param paymentMethod Méthode de paiement
     * @return La commande mise à jour
     */
    PharmacyOrderDTO confirmPaymentByFinance(Long orderId, Long cashierId, BigDecimal amountPaid, String paymentMethod);
