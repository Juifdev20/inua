          ...
          {!sidebarCollapsed ? (
            <div className="flex items-center gap-3 animate-slideInFromLeft w-full overflow-hidden">
              ...
              <div className="overflow-hidden">
                <h1 className="text-lg font-space-grotesk font-bold text-primary tracking-tight truncate">{config?.appName || 'INUA AFYA'}</h1>
        ...
        <aside className="fixed inset-y-0 left-0 z-50 w-72 bg-card border-r border-border lg:hidden shadow-2xl flex flex-col">
          <div className="h-16 flex items-center justify-between px-4 border-b border-border">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg font-bold text-primary">{config?.appName || 'INUA AFYA'}</h1>
            </div>
