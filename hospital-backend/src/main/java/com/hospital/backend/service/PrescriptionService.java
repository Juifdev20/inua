...
public interface PrescriptionService {
    ...
    PageResponse<PrescriptionDTO> getPaidPrescriptions(LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);
    PrescriptionDTO dispense(Long id, Long pharmacistId);
    PrescriptionDTO updateStatus(Long id, PrescriptionStatus status);
    void updateItems(Long prescriptionId, List<Map<String, Object>> items);
    void delete(Long id);
}
