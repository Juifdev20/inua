...
public interface AdmissionRepository extends JpaRepository<Admission, Long> {
    ...
    List<Admission> findByCompanyIdAndAdmissionDateBetween(Long companyId, LocalDateTime start, LocalDateTime end);

    // ── Optimisation pour éviter OOM dans getAdmissionsQueue ───────────────────────
