...
public class LabTest {
    ...
    // âœ… NOUVEAU : Le docteur qui doit recevoir les rÃ©sultats
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    // âœ… MODIFICATION : Ce champ contiendra le JSON des valeurs saisies dans le frontend
    @Column(columnDefinition = "TEXT")
    ...
    /**
     * GÃ©nÃ¨re un code unique pour le test
