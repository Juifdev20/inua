...
const PharmacySettings = () => {
  ...
  const handleLogoChange = (e) => {
    ...
    // For now, we'll use the base64 preview as the logoUrl
    toast.success('Photo sélectionnée. Cliquez sur "Sauvegarder" pour confirmer.');
  };
  ...
  const loadSettings = useCallback(async () => {
    try {
      ...
      if (saved) {
        ...
        // 🔧 Initialize logo preview if logoUrl exists
  ...
  const handleSave = async () => {
    try {
      ...
      // 🔧 Include logo preview in settings if exists
      ...
      localStorage.setItem('pharmacy_settings', JSON.stringify(settingsToSave));
      
      // In a real app, you would also save to API
      // await savePharmacySettings(settingsToSave);
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 space-y-2">
              <p className="text-xs text-muted-foreground">
                Téléchargez une photo ou un logo pour votre pharmacie.<br />
                ...
                <label className="cursor-pointer">
                  ...
                  >
                    <span>
                      ...
                      {uploadingLogo ? 'Téléchargement...' : (logoPreview || settings.logoUrl ? 'Changer la photo' : 'Ajouter une photo')}
                    </span>
                  </Button>
                </label>
                {(logoPreview || settings.logoUrl) && (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="rounded-lg font-bold border-red-500/50 text-red-600 hover:bg-red-50"
                    onClick={handleRemoveLogo}
                  >
