...
public class User {
    ...
    @Column(unique = true, nullable = true) // Nullable pour les patients sans email
    ...
    // ✅ CHAMP POUR FORCER LE CHANGEMENT DE MOT DE PASSE AU PREMIER LOGIN
    ...
    // ★ CHAMPS POUR OAUTH2 SOCIAL LOGIN (Google, Facebook)
    @Column(name = "oauth_provider", length = 50)
    @JsonIgnore
    private String oauthProvider;  // "google" ou "facebook"

    @Column(name = "oauth_id", length = 255)
    @JsonIgnore
    private String oauthId;  // ID unique du provider OAuth2

    // ★ CHAMPS POUR CONNEXION PAR CODE (Magic Code / Passwordless)
    @Column(name = "login_code", length = 6)
    @JsonIgnore
    private String loginCode;  // Code à 6 chiffres
