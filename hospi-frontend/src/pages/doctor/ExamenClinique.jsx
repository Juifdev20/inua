...
const ExamenClinique = () => {
  ...
  const generatePDF = () => {
    try {
      ...
      doc.text(config.hospitalName?.toUpperCase() || 'INUA AFYA', 105, 20, { align: "center" });
      ...
      doc.text(config.footerText || `© ${config.hospitalName || 'INUA AFYA'} - Tous droits réservés`, 105, pageHeight - 15, { align: "center" });
